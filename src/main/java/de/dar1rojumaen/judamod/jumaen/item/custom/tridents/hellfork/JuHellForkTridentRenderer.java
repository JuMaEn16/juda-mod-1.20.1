...
public class JuHellForkTridentRenderer extends EntityRenderer<JuHellForkTridentEntity> {
    private static final Identifier TRIDENT_EMISSIVE_TEXTURE = new Identifier(JuDaMod.MOD_ID, "textures/entity/hellfork_trident_emissive.png");
    private final JuHellForkTridentModel model;

    public JuHellForkTridentRenderer(EntityRendererFactory.Context context) {
        super(context);
        this.model = new JuHellForkTridentModel(context.getPart(JuHellForkTridentModelLayers.HELL_TRIDENT_LAYER));
    }

    @Override
    public Identifier getTexture(JuHellForkTridentEntity entity) {
        return JuHellForkTridentModel.TEXTURE; // Use your custom texture
    }

    @Override
    public void render(JuHellForkTridentEntity tridentEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumers, int i) {
        matrixStack.push();
