...
public class JuHellForkTridentEntity extends PersistentProjectileEntity {
    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(JuHellForkTridentEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(JuHellForkTridentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private ItemStack tridentStack = new ItemStack(JuModItems.HELLFORK_TRIDENT);
    private boolean dealtDamage;
    public int returnTimer;
    private Vec3d lastPosition;

    // RGB values for the dust color
    private static final float DUST_RED = 1F;   // Red (0.0 to 1.0)
    private static final float DUST_GREEN = 0.0F; // Green (0.0 to 1.0)
    private static final float DUST_BLUE = 0.0F;  // Blue (0.0 to 1.0)
    private static final float DUST_SIZE = 0.9F;  // Particle size

    public JuHellForkTridentEntity(EntityType<? extends JuHellForkTridentEntity> entityType, World world) {
        super(entityType, world);
    }

    public JuHellForkTridentEntity(World world, LivingEntity owner, ItemStack stack) {
        super(JuModEntities.HELLFORK_TRIDENT_ENTITY, owner, world);
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        entity.setFireTicks(100 + fireTicks);
